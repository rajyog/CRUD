...
<div class="form-group">
    ...
    <div class="col-sm-6">
      <input type="date" class="form-control"  id="bday" placeholder="Select Birth Date" name="bday">
  </div>
...
<div class="form-group">
    ...
    <div class="col-sm-6">
      <textarea class="form-control" id="address" placeholder="Please Enter Address" name="address"></textarea>
  </div>
...
<div class="form-group">
    ...
    <div class="col-sm-6">
      <input type="text" class="form-control" id="mobile" placeholder="Please Enter Mobile number" name="mobile">
  </div>
...
<div class="form-group">
    ...
    <div class="col-sm-6">
      <input type="email" class="form-control" id="email" placeholder="Please Enter Email" name="email">
  </div>
